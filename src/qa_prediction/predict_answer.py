...
if __name__ == "__main__":
    ...
    argparser.add_argument("--vanilla_llm", action="store_true")
    argparser.add_argument(
    "--output_path",
    type=str,
    default=None)
    ...
    if getattr(args, "vanilla_llm", False):
            args.add_path = False
            args.use_pred_path = False
            args.pred_triple_path_path = None
            args.output_path = "results/vanilla/predictions.jsonl"
